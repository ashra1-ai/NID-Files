...
class SuricataSimulator:
        ...
        if match:
            ...
            for option in options:
                ...
                if ':' in option:
                    ...
                    parsed_options[option] = True  # Options without values are treated as flags
    ...
    def check_http_post(self, headers, body):
        normalized_headers, normalized_body = self.normalize_http_post(headers, body)
        ...
        for rule in self.rules:
            ...
            if 'http_header' in rule:
                ...
                if header.lower() in normalized_headers and value.strip('"') in normalized_headers[header.lower()]:
                    alerts.append(f"Alert: {rule.get('msg', 'Unknown alert')}")
